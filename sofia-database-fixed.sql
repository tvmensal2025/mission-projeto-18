-- Script corrigido para garantir que Sofia tenha tudo necessário SEM DUPLICAR
...
-- =============================================
-- 4. TABELA AI_CONFIGURATIONS (SOFIA) - CORRIGIDA
-- =============================================
...
BEGIN
    IF NOT EXISTS (
        ...
        WHERE conname = 'ai_configurations_functionality_key'
    ) THEN
...
-- =============================================
-- 7. CONFIGURAÇÕES DE IA PARA SOFIA (CORRIGIDO)
-- =============================================

-- Deletar configurações existentes e inserir novas
DELETE FROM public.ai_configurations WHERE functionality IN (
    'health_chat', 'medical_analysis', 'food_analysis', 'weekly_report', 'emotional_analysis'
);
...
-- Mostrar configurações de IA inseridas
SELECT functionality, service, model, max_tokens, temperature, is_active 
FROM public.ai_configurations 
WHERE functionality IN ('health_chat', 'medical_analysis', 'food_analysis', 'weekly_report', 'emotional_analysis')
