...
export const CompetencyWheel: React.FC<CompetencyWheelProps> = ({
  ...
  const getScoreColor = (score: number) => {
    if (score <= 2) return '#ef4444'; // vermelho (1-2)
    if (score <= 4) return '#f97316'; // laranja (3-4)
    if (score <= 6) return '#eab308'; // amarelo (5-6)
    if (score <= 8) return '#10b981'; // verde (7-8)
    return '#3b82f6'; // azul (9-10)
  };
