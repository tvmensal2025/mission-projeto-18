        ...
        return (
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-3xl font-bold">🚀 IA Inteligente</h1>
                <p className="text-muted-foreground">Configuração Avançada - MÁXIMO/MEIO/MÍNIMO + Relatórios Inteligentes</p>
              </div>
